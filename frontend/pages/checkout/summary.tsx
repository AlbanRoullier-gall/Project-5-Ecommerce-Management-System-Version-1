...
export default function CheckoutSummaryPage() {
  ...
  }, [cart, isLoading, customerData, addressData, router]);
  ...
  return (
    <>
      <Head>
        <title>Récapitulatif et paiement - Checkout - Nature de Pierre</title>
        <meta
          name="description"
          content="Récapitulatif de votre commande et paiement"
        />
      </Head>
